...
void simulation(bool affiche)
{
    ...
    while (!quitting)
    {
        ...
        std::chrono::duration<double> time_without_display = end_day_without_display - start_day;
        std::chrono::duration<double> total_time = end_day - start_day;
        std::chrono::duration<double> display_time = end_day - end_day_without_display;

        std::cout << "Temps simulation sans affichage : " << time_without_display.count() << "s\n";
        std::cout << "Temps simulation avec affichage : " << total_time.count() << "s\n";
        std::cout << "Temps affichage : " << display_time.count() << "s\n";
