...
// --------------------------------------------------------------------------------------------------------------------
void epidemie::Individu::estContamine(Grippe &grippe)
{
...
// --------------------------------------------------------------------------------------------------------------------
void epidemie::Individu::estContamine(AgentPathogene &agent)
{
...
// --------------------------------------------------------------------------------------------------------------------
bool epidemie::Individu::testContaminationGrippe(Grille const &grille, Interactions const &t_interactions,
...
//
bool epidemie::Individu::testContaminationAgent(Grille const &grille, AgentPathogene &agent)
{
    if (this->m_agent_pathogene.temps_contagieux > 0)
        return false;
    auto [largeur, hauteur] = grille.dimension();
    Grille::StatistiqueParCase const &statistiques = grille.getStatistiques()[m_position.x + m_position.y * largeur];
...
//
void epidemie::Individu::setPosition(int largeur, int hauteur)
{
